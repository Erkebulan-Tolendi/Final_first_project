...
public class TestAna extends AppCompatActivity {
    ...
    String [] suraktar ={"Ана армияға бардыма?", "Ананын жасы қаншада?", "Ана не жақсы көреді?", "Ана күштіма?", "Ана машина айдайма?", "Ана қанша немересі бар?", "Ана ұнататаын тамағы?", "Ана ақылды ма?","Ананы жақсы көресінба?", "Ана сені жақсы көрема?"};
    String [][] variant={
            {"иа", "жок","мумкин","нет"},
            {"72", "40", "54", "95"},
    ...
    String answer[] ={"жок", "40", "китап", "әрине","жок", "4", "манты", "иа","Әрине", "солай шығар"};
    int count = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.test_ana);
