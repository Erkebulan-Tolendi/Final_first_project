package kz.example.finalproject.ui.home;
...
public class HomeFragment extends Fragment {
    ...
    View view;
    Button btn_test_ata, btn_wp, btn_telegram,btn_instagram, btn_call, btn_sms;
    Activity context;

    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        context = getActivity();

        view = inflater.inflate(R.layout.fragment_ata, container, false);
    ...
    public void onStart() {
        super.onStart();
        btn_test_ata = (Button) context.findViewById(R.id.btn_test_ata);
        btn_test_ata.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent (context, TestPar.class);
                startActivity(intent);
            }
        });
    }
