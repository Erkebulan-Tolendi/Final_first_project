...
public class AnaFragment extends Fragment {
    ...
    Button btn_test_ana, btn_wp, btn_telegram,btn_instagram, btn_call, btn_sms;
    ...
    public void onStart() {
        super.onStart();
        btn_test_ana = (Button) context.findViewById(R.id.btn_test_ana);
        btn_test_ana.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent (context, TestAna.class);
                startActivity(intent);
            }
        });
    }
