...
public class TestParApa extends AppCompatActivity {
    ...
    String [] suraktar ={"Jaksy koretin tys ?","Jasy kanshada ?","Anasinin ati ?", "Kai jerde jumis jasagan ?", "Favorite car ?", "Kuieuinin ati kim ?", "Kansha Balasi bar ?", "Nagashisinin ati ? ", "Akesinin ati ?", "Turatin jeri ?"};
    String [][] variant={
            ...
            {"Bmw", "M Benz", "Daf","Fiat"},
            {"Jasko", "Tolen", "Maria","Farhad"},
            {"7", "3", "9","15"},
            {"Jasko", "Toibek", "Maksat","Asan"},
            {"Saginbai", "Ibrahim", "Berdesh","Faizulla"},
            {"Taraz", "Shiely", "Dikhan","Burnoe"},


    };
    String answer[] ={"red","85","Daria","Milk farm", "Fiat", "Maria", "9", "Toibek", "Berden", "Dikhan"};
    int count = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test_par);
        ...
        btn_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn_bal.setText("Score: "+(""+(count*10)+"%"));
